...
from  ..tools import batched_index_select, BertOnlyMLMHead, RobertaLMHead, DebertaV2OnlyMLMHead, LongformerLMHead
...
class DebertaForBasePrompt(DebertaV2PreTrainedModel):
    def __init__(self, config, args):
        super().__init__(config)
...
class DebertaForMixPrompt(DebertaV2PreTrainedModel):
    def __init__(self, config, args):
        super().__init__(config)
        self.deberta = DebertaV2Model(config)
        self.cls = DebertaV2OnlyMLMHead(config)
...
class DebertaForSimpMixPrompt(DebertaV2PreTrainedModel):
    def __init__(self, config, args):
        super().__init__(config)
        self.deberta = DebertaV2Model(config)
        self.cls = DebertaV2OnlyMLMHead(config)
...
class LongformerForSimpMixPrompt(LongformerPreTrainedModel):
    def __init__(self, config, args):
        super().__init__(config)
        self.longformer = LongformerModel(config, add_pooling_layer=False)
        self.lm_head = LongformerLMHead(config)

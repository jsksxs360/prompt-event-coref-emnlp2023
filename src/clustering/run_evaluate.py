...
from src.clustering.utils import get_pred_clusters
from src.clustering.utils import create_golden_conll_file, create_pred_conll_file
...
if __name__ == '__main__':
    ...
    # {doc_id: [[c1_e1_start, c1_e2_start, ...], ...]}
    cluster_dict = get_pred_clusters(args.test_cluster_filepath)
    logger.info(f'creating predicted conll file in {args.output_dir} ...')

                ...
                for j in range(i + 1, len(events)):
                    ...
                    if e_i_start < e_j_start:
                        ...
                        event_pairs[f'{e_j_start}-{e_i_start}'] = [
                            1 if e_i_cluster_id == e_j_cluster_id else 0, abs(int(e_i_sent_idx) - int(e_j_sent_idx)), e_j_link_len, e_i_link_len
                        ]
        ...
        for line in f:
            ...
            for i in range(len(events) - 1):
                ...
                for j in range(i + 1, len(events)):
                    ...
                    event_pairs[f'{e_i_start}-{e_j_start}'] = [
                        pred_labels[event_pair_idx], abs(int(e_i_sent_idx) - int(e_j_sent_idx)), 0, 0
                    ]
                    event_pair_idx += 1
